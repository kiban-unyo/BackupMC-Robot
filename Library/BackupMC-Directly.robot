  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="3" id="3">
        <property name="name" class="String">ターゲット抽出</property>
        <property name="stepAction" class="ExtractTarget">
          <property name="urlProvider" class="kapow.robot.plugin.common.stepaction.urlprovider2.ExpressionURLProvider2">
            <property name="expression" class="String">&gt;&gt;http://&lt;&lt; + backup.hostname + &gt;&gt;/secure/Backup&lt;&lt;</property>
          </property>
          <property name="storeIn" class="kapow.robot.plugin.common.support.dataloader.FileDataStoreProvider">
            <property name="fileName" class="kapow.robot.plugin.common.support.expression.multipletype.StringProcessorsExpression" serializationversion="0">
              <property name="dataConverters" class="DataConverters">
                ...
                <element class="Extract2DataConverter">
                  ...
                  <property name="specifiedDescription" class="String">ファイル名抽出</property>
                </element>
              </property>
            </property>
            <property name="directory" class="kapow.robot.plugin.common.support.expression.multipletype.StringProcessorsExpression" serializationversion="0">
              <property name="dataConverters" class="DataConverters">
                <element class="GetVariable" serializationversion="2">
                  <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                    <property name="name" class="String">backup.filename</property>
                ...
                <element class="Extract2DataConverter">
                  ...
                  <property name="specifiedDescription" class="String">ファイルパス抽出</property>
                </element>
              </property>
            </property>
